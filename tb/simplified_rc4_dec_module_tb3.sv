module rc4_dec_module_tb3;
	...
	reg	din_valid;
	reg	[7:0]	key	[31:0];
	reg	[7:0]	ciphertext0 [22:0]; // cifrato
    reg	[7:0]	plaintext0  [22:0]; // plain
	...
	initial begin
		@(posedge rst_n)
		$readmemb("tv/key3.txt", key);
		$readmemb("tv/cipher3.txt", ciphertext0);
		$readmemb("tv/plain3.txt", plaintext0);
