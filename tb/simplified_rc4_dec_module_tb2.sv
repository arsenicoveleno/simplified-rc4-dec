module rc4_dec_module_tb2;
	...
	reg	din_valid;
	reg	[7:0]	key	[31:0];
	reg	[7:0]	ciphertext0 [64:0]; // cifrato
    reg	[7:0]	plaintext0  [64:0]; // plain
	...
	initial begin
		@(posedge rst_n)
		$readmemb("tv/key2.txt", key);
		$readmemb("tv/cipher2.txt", ciphertext0);
		$readmemb("tv/plain2.txt", plaintext0);
