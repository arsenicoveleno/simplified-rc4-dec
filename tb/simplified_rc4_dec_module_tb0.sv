module rc4_dec_module_tb0;
	...
	reg	din_valid;
	reg	[7:0]	key	[31:0];
	reg	[7:0]	ciphertext0 [25:0]; // cifrato
    reg	[7:0]	plaintext0  [25:0]; // plain
	...
	initial begin
		@(posedge rst_n)
		$readmemb("tv/key0.txt", key);
		$readmemb("tv/cipher0.txt", ciphertext0);
		$readmemb("tv/plain0.txt", plaintext0);
